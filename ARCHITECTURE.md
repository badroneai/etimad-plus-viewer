...
فيأتي من commit ثابت على `publication/kashaf-data`. الإشارة بلا صلاحية نشر
مسار سريع best-effort؛ fallback الحاكم poll موثوق من `main` كل عشر دقائق يقارن
`snapshot_id` وSHA-256 للـmanifest المنشور مع الموقع الحي. عند التطابق لا يشغّل
البوابات الثقيلة أو deploy. عند الاختلاف يتحقق Workflow من الرأس الثابت،
ويرفض الروابط الرمزية، ثم
