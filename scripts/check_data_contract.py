...
from interval_coverage_audit import (
    assert_single_day_refinement_contract as assert_single_day_refinement_contract_audit,
)
...
def _assert_single_day_refinement_contract(
    ...
    *,
    ...
    assert_single_day_refinement_contract_audit(
        ...
        blocked_interval_count=blocked_interval_count,
